 ...
 * que antes estaba en la landing page. No tiene enlaces desde la UI.
 * Solo accesible escribiendo /info en la URL.
 */
...
const FASE5_FEATURES = [
  ...
  },
  {
    ...
    desc: 'Confirmación de orden con diseño branded (vía Brevo en prod, log a consola en dev). Email de reembolso también.',
  },
  {
    icon: Sparkles,
...
const PHASE5_CHECKLIST = [
  ...
  { done: true, label: 'Emails transaccionales (Brevo) — confirmación de orden' },
    ...
    <div className="relative">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Las rutas marcadas como <code className="text-foreground">en vivo</code> operan con datos reales de Neon Postgres.
          </p>
        </div>
        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardContent className="flex flex-col items-center gap-4 p-8 text-center">
            ...
            <p className="max-w-xl text-muted-foreground">
              ...
              Configura tus credenciales en las variables de entorno y despliega en Vercel.
            </p>
