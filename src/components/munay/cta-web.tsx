...
export function MunayCtaWeb() {
  return (
    <section className="relative flex flex-col items-center justify-between gap-6 overflow-hidden rounded-2xl bg-gradient-to-r from-munay-terracota to-munay-terracota-quemado px-6 py-10 shadow-sm sm:px-10 lg:flex-row">
